 ...
 //connexion a la base de donnée
    ...
    //selection des champs et attribution a des variables
        ...
        if(isset($_POST['credit'])){
          ...
          $prix_paye=strtoupper(htmlspecialchars($_POST["montant"]));
          $tel_paye=strtoupper(htmlspecialchars($_POST["tel"]));
          $rete =$bdd->query("INSERT INTO reglement_inter (id_livreur,type,prix,tel_transf) values (".$_SESSION['codeliv'].",'credit','".$prix_paye."','".$tel_paye."')");

          //header("location:admin_liv_credit_attente.php");
          
           ?>
  <script>
                document.location.href="admin_liv_credit_attente.php";
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
           <ul>
            ...
            <li><a href="admin_liv_crediter.php" class="active"><i class="fa fa-database fa-fw"></i>reglement credit</a></li>
      ...
      <div class="templatemo-top-nav-container">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Créditer mon compte</h2></center>
            <hr>
            ...
            <div class="templatemo-content-widget white-bg col-1 templatemo-position-relative templatemo-content-img-bg">
              ...
              <h2 class="templatemo-position-relative black-text text-center">Plus de credit pour plus de commande</h2>
              <hr>

              <br/>
              <br/>

              <h3 class="templatemo-position-relative black-text text-center"> Pour créditer votre compter vous devez effectuer un versement du montant a crediter par Orange Money au 78 058 79 29</h3>
              
              <br/>
              <br/>

              
              <center><button onclick="goBack()" class="templatemo-red-button">Annuler</button>  </center>
            
              <hr>
              <h3 class="templatemo-position-relative black-text text-center">Si le depôt a été effectué :</h3>
              <br/>
              <h3 class="templatemo-position-relative black-text text-center">Veuillez saisir le montant versé et le numéro de téléphone avec lequel le dépôt a été effectué :</h3>
             <br/>

              <form method="post" class="templatemo-login-form">
                    <div class="form-group">
                      <input type="text" class="form-control" id="inputEmail"  placeholder="Entrer le montant envoyé" name="montant" pattern="(?=.*[0-9]).{3,}" title="saisissez uniquement des chiffres(minimum 3 chiffres)" required>
                    </div>

                    <div class="form-group">
                      <input type="tel" class="form-control" id="inputEmail" placeholder="Entrer le numero de téléphone de transfert" name="tel" pattern="[0-9]{9}" required>
                    </div>
                    <div class="form-group">
                      <center><button type="submit" name="credit" value="ok" class="templatemo-blue-button">Crédit Payé</button></center>
                    </div>
                  </form>
