          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li><a href="encoursliv.php" class="active">En cours</a></li>
...
$rete=$con->query("SELECT * FROM Livreur",PDO::FETCH_BOUND);
  ...
  $rete->bindColumn('IDLIV',$IDLIV);
  $rete->bindColumn('NOMLIV',$NOMLIV);
  $rete->bindColumn('PRENOMLIV',$PRENOMLIV);
  $rete->bindColumn('TELLIV',$TELLIV);
  $rete->bindColumn('DATEE',$DATEE);
  $rete->bindColumn('CATEGORIE',$CATEGORIE);
  $rete->bindColumn('DOMAINE',$DOMAINE);
 ?>
                ...
                <table class="table table-striped table-bordered templatemo-user-table">
                  <thead>
                    <tr>
                      ...
                      <td><a href="" class="white-text templatemo-sort-by">Categorie<span class="caret"></span></a></td>
                      <td><a href="" class="white-text templatemo-sort-by">Domaine<span class="caret"></span></a></td>
                      <td>Edit</td>
                      <td>Action</td>
                      <td>Delete</td>
                    </tr>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php print $IDLIV; ?></td>
                        <td><?php print $NOMLIV; ?></td>
                        <td><?php print $PRENOMLIV; ?></td>
                        <td><?php print $TELLIV; ?></td>
                        <td><?php print $DATEE; ?></td>
                        <td><?php print $CATEGORIE; ?></td>
                        <td><?php print $DOMAINE; ?></td>
