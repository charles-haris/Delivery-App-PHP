...
$bdd = connect();
  ...
  if (isset($_GET['restore'])){
    $requ=$bdd->query("UPDATE commerciaux set active='oui' WHERE IDCOM='".$_GET['IDCOM']."' ");
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="commercial_liste_restore.php">
    <!-- 
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des commerciaux</h2></center>
        ...
        $total=$con->prepare("SELECT COUNT(*) as totaux FROM  commerciaux where active='non'");
        $total->execute();
        $t=$total->fetch();
        $nbr=(int)$t['totaux'];
        ...
        $rete=$con->prepare("SELECT * FROM  commerciaux where active='non'  limit :premier, :parpage");
            ...
            <?php if($nbr>0){ ?>
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="commercial_liste_restore.php?IDCOM=<?php  echo $id;?>&restore=ok" class="templatemo-edit-btn btn-danger "><i class="fa fa-ban" aria-hidden="true"></i> </a></td>
                        </form>
              ...
              <ul class="pagination">
                  ...
                  <?php }else{ ?>
                    ...
                    <hr>
                    <p class="text-center text-uppercase"> Aucun commercial n'a été desactivé.</p>
