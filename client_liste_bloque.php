...
$bdd = connect();
  ...
  if (isset($_GET['debloq'])){
    $requ=$bdd->query("UPDATE client set bloque='non' WHERE IDCLI='".$_GET['IDCLI']."' ");
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="client_liste_bloque.php">
    <!-- 
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="client.php"  >Ajout Client</a></li>
                <li><a href="client_liste_bloque.php" class="active">compte(s) bloqué(s)</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des clients bloqués</h2></center>
    </div>
        ...
        $rete=$con->query("SELECT * FROM  client where active='oui' and bloque='oui' ",PDO::FETCH_BOUND);
...
?>
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  <thead>
                    <tr>
                      ...
                      <td><a href="" class="white-text templatemo-sort-by">Identifiant<span class="caret"></span></a></td>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php print $identi; ?></td>
                    
        
                        
                        <td><a href="client_liste_bloque.php?IDCLI=<?php  echo $id;?>&debloq=ok" class="templatemo-edit-btn btn-danger" >Débloquer</a></td>
            ...
            <hr>
            <p class="text-center text-uppercase"> Aucun client n'a été bloqué.</p>
...
function myunction() {
  var txt;
  var r = confirm("Voulez vous vraiment supprimer charles");
  if (r == true) {
    txt = "You pressed OK!";
  } else {
