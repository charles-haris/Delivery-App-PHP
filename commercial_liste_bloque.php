...
$bdd = connect();
  ...
  if (isset($_GET['debloq'])){
    $requ=$bdd->query("UPDATE commerciaux set bloque='non' WHERE IDCOM='".$_GET['IDCOM']."' ");
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="commercial_liste_bloque.php">
    <!-- 
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des commerciaux bloqués</h2></center>
        ...
        $total=$con->prepare("SELECT COUNT(*) as totaux FROM  commerciaux where  bloque='oui'");
        $total->execute();
        $t=$total->fetch();
        $nbr=(int)$t['totaux'];
        ...
        $rete=$con->prepare("SELECT * FROM  commerciaux where bloque='oui' limit :premier, :parpage");
       ...
       $rete->bindColumn('adresse',$ADRESSE);
            ...
            <?php if($nbr>0){ ?>
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="commercial_liste_bloque.php?IDCOM=<?php  echo $id;?>&debloq=ok" class="templatemo-edit-btn btn-danger "><i class="fa fa-ban" aria-hidden="true"></i> </a></td>
                        </form>
              ...
              <ul class="pagination">
                  ...
                  <?php }else{ ?>
                    ...
                    <hr>
                    <p class="text-center text-uppercase"> Aucun commercial n'a été bloqué.</p>
