      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste de toutes les livraisons</h2></center>
    </div>
        ...
        $total=$con->prepare("SELECT COUNT(*) as totaux FROM  livraison where Annuler='non' ");
        $total->execute();
        $t=$total->fetch();
        $nbr=(int)$t['totaux'];
        ...
        $rete=$con->prepare("SELECT IDCOLIS,client.IDCLI as id,nom,typescolis,poids,volume,adresseOrig,adresseLivraison,nbColis,Statut,Description,livraison.TypeVehicule,IDLIV FROM livraison,client where livraison.IDCLI=client.IDCLI and Annuler='non' limit :premier, :parpage");
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  <thead>
                    <tr>
                      ...
                      <td><a href="" class="white-text templatemo-sort-by">Code Client<span class="caret"></span></a></td>
