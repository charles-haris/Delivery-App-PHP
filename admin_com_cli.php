...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="admin_com_cli.php">
    <!-- 
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
         ...
         <?php include("admin_com_menu.php"); ?>
          ...
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des clients partenaires</h2></center>
    </div>
        ...
        $total=$con->prepare("SELECT COUNT(*) as totaux FROM  client where IDCOM='".$_SESSION['codecom']."' ");
        $total->execute();
        $t=$total->fetch();
        $nbr=(int)$t['totaux'];
        ...
        $rete=$con->prepare("SELECT * FROM  client where IDCOM='".$_SESSION['codecom']."' limit :premier, :parpage");
