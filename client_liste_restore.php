...
$bdd = connect();
  ...
  if (isset($_GET['restaure'])){
    $requ=$bdd->query("UPDATE client set active='oui' WHERE IDCLI='".$_GET['IDCLI']."' ");
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="client_liste_restore.php">
    <!-- 
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li><a href="client_liste_restore.php" class="active">Restaurer</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des clients Supprimés</h2></center>
    </div>
        ...
        $rete=$con->query("SELECT * FROM  client where active='non' ",PDO::FETCH_BOUND);
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="client_liste_restore.php?IDCLI=<?php  echo $id;?>&restaure=ok" class="templatemo-edit-btn btn-danger" >Restaurer</a></td>
...
<hr>
<p class="text-center text-uppercase"> Aucun client n'a été supprimé.</p>
