...
if(!isset($_SESSION['id'])){
 ...
 //connexion a la base de donnée
     ...
     $action1 =$bdd->query("
     select * from abonnement where actif='encours' and id_liv=".$_SESSION['codeliv']." ");
     $nbr_act1=$action1->rowCount();

         if($nbr_act1<1){
          $acc=$bdd->query("select * from livreur where Abonne='oui' and IDLIV='".$_SESSION['codeliv']."' ");
          $nbr_acc=$acc->rowCount();
                   if($nbr_acc==1){
                      echo '
                      <script type="text/javascript">
                      swal ( " Un administrateur a validé  votre confirmation de paiement." ) ;
                    ...
                    <?php
                      ...
                      echo '
                      <script type="text/javascript">
                      swal ( " Un administrateur a refuté votre confirmation de paiement. Veuillez nous contacter!" ) ;
                      </script>';
                      sleep(60);
                      //header("location:admin_livreur.php");
        ...
        $recup1=$bdd->query("select duree from abonnement where id_liv='".$_SESSION['codeliv']."' and actif='encours' ");
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Refresh" content="60"; url="admin_liv_abonne_attente.php">
  ...
  <body>  
    <!-- Left column -->
      ...
      <div class="templatemo-sidebar">
        ...
        <ul>
                        <li><a href="https://t.me/joinchat/SAKrk-AzDHlhMWI0" style="color:red;"><i class="fa fa-telegram "></i>Acceder a la communaute</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Attente de validation du paiement de l'abonnement choisi</h2></center>
            <hr>
            ...
            <div class="templatemo-content-widget white-bg col-1 templatemo-position-relative templatemo-content-img-bg">
              ...
              <h3 class="templatemo-position-relative black-text text-center">Veuillez attendre qu'un administrateur vérifie le montant et votre numéro de tranfert pour valider votre Abonnement.</h3>
