...
$bdd = connect();
$requ=$bdd->query( "SELECT *  FROM client WHERE IDCLI='".$_GET['IDCLI']."' ");
$aff=$requ->fetch();
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Modification d'un client</h2></center>
            <hr>
            <form action="" method="post">
              ...
              <div class=" col-sm-12 form-group">                  
                ...
                <div class=" col-md-6 form-group">                  
                    ...
                    <input type="text" name="tel" class="form-control " placeholder="Ex:78......." id="inputCurrentPassword"  value="<?php  echo $aff['tel'];?>" required="">                  
                </div>                
