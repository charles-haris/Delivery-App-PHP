...
$bdd = connect();
if (isset($_GET['supp'])){
	$requ=$bdd->query("UPDATE livreur set active='non' WHERE IDLIV='".$_GET['IDLIV']."' ");
	
  }
  $modal="";
  if (isset($_GET['bloq'])){
    $requ=$bdd->query("UPDATE livreur set bloque='oui' WHERE IDLIV='".$_GET['IDLIV']."' ");
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Liste des livreurs</h2></center>
        ...
        $total=$con->prepare("SELECT COUNT(*) as totaux FROM  livreur where active='oui' and bloque='non'");
        $total->execute();
        $t=$total->fetch();
        $nbr=(int)$t['totaux'];
        ...
        $rete=$con->prepare("SELECT * FROM  livreur where active='oui' and bloque='non' limit :premier, :parpage");
              ...
              <table class="table table-hover mt-3 table-striped table-bordered templatemo-user-table text-center " id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="livreur_modification.php?IDLIV=<?php  echo $id;?>" class="templatemo-edit-btn" ><i class="fa fa-pencil-square" aria-hidden="true"></i></a></td>
                        <td><a href="livreur_liste.php?IDLIV=<?php  echo $id;?>&bloq=ok" class="templatemo-edit-btn btn-danger "><i class="fa fa-ban" aria-hidden="true"></i> </a></td>
                        <td><a href="livreur_liste.php?IDLIV=<?php  echo $id;?>&supp=ok" class="templatemo-edit-btn btn-danger" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </form>
