...
$bdd = connect();
$requ=$bdd->query( "SELECT *  FROM commerciaux WHERE IDCOM='".$_GET['IDCOM']."' ");
$aff=$requ->fetch();
$error="";
if(isset($_POST["envoi"]))
{
 ...
 ,identifiant=:identifiant ,password=:password
  ...
  if(isset($_POST["IDCOM"]))  $ID=$_POST["IDCOM"];
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <center><h2 class="margin-bottom-10">Modification d'un agent commercial</h2></center>
            <hr>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                   <div class=" col-sm-12 form-group">                  
                    <label for="inputLastName">Code Commercial</label>
                ...
                <div class=" col-md-6 form-group">                  
                    ...
                    <input type="text" name="nom_com" value="<?php  echo $aff['nom_com'];?>" class="form-control" id="inputLastName" placeholder="votrte nom" required="">                  
                </div> 
              
             
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">PRENOM</label>
                    <input type="text" name="prenom_com" value="<?php  echo $aff['prenom_com'];?>" class="form-control" id="inputUsername" placeholder="votre prenom" required="">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">TEL</label>
                    <input type="text" name="tel_com" value="<?php  echo $aff['tel_com'];?>" class="form-control" id="inputEmail" placeholder="Ex:78......." required="">                  
                </div> 
       
             
                <div class=" col-md-6 form-group">                  
                    <label for="inputCurrentPassword">ADRESSE</label>
                    <input type="text" name="adresse_com" value="<?php  echo $aff['adresse_com'];?>" class="form-control " placeholder="" id="inputCurrentPassword" required="">                  
                </div>                
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="password" name="password" value="<?php  echo $aff['password'];?>" class="form-control" placeholder="votre mot de passe" id="inputConfirmNewPassword">
                </div> 
              <br>
              <br>
                  <hr> 
